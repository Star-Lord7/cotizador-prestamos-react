...
function App() {
  // useState se usa para manejar el estado de una variable en un componente funcional
  ...
  useEffect(() => {
    const resultadoTotalPagar = calcuarTotalPagar(cantidad, meses);
  ...
  function handleClickDecremento(){
    ...
    setCantidad(Math.max(valor, MIN));
  }

  function handleClickIncremento(){
    const valor = cantidad + STEP;
    setCantidad(Math.min(valor, MAX));
  }
